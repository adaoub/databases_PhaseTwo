...
students, student_names, cohort_name, cohort starting_dates, cohorts
```
...
2. Name of the second table (always plural): `cohorts ` 
    ...
    Column names: `name` , `strating_date`
...
students --> many to one --> cohorts
cohorts --> one to mnay --> students
